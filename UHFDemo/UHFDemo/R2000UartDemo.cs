...
namespace UHFDemo
{
    public partial class R2000UartDemo : Form
    {
        ...
        private void R2000UartDemo_Load(object sender, EventArgs e)
        {
            ...
            ipIpServer.IpAddressStr = "192.168.1.179";
        ...
        {
            string strCmd = "Read Signature Set";
        ...
        private void ProcessInventoryReal(Reader.MessageTran msgTran)
        {
            ...
            else
            {
                ...
                //Add inventory list
                string strEPC = CCommondMethod.ByteArrayToString(msgTran.AryData, 3, nEpcLength) + "ahsu ashu ashuhas  ";
                Console.WriteLine(strEPC);
                string strPC = CCommondMethod.ByteArrayToString(msgTran.AryData, 1, 2);
                string strRSSI = string.Empty;
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            ...
            if (txt_format_buffer_rb.Checked)
            {
                ...
                if (saveFileDialog1.FileName != "")
                {
                    ...
                    fs.Close();
                    MessageBox.Show("Export data success......and FUCK YOUUUUUU！");
                }
            }
